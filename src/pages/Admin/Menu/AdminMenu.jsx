  ...
  return (
    <div className="sidebar">
      ...
      <Link to="/home">
        <div
          className={`${
            path === '/home' ? 'sidebar-item-selector' : 'sidebar_item'
          }`}
        >
      ...
      <Link to="/deposit">
        <div
          className={`${
            path === '/deposit' ? 'sidebar-item-selector' : 'sidebar_item'
          }`}
        >
      ...
      <Link to="/pay">
        <div
          className={`${
            path === '/pay' ? 'sidebar-item-selector' : 'sidebar_item'
          }`}
        >
      ...
      <Link to="/invoice">
        <div
          className={`${
            path === '/invoice' ? 'sidebar-item-selector' : 'sidebar_item'
          }`}
        >
      ...
      <Link to="/customer">
        <div
          className={`${
            path === '/customer' ? 'sidebar-item-selector' : 'sidebar_item'
          }`}
        >
      ...
      <Link to="/product">
        <div
          className={`${
            path === '/product' ? 'sidebar-item-selector' : 'sidebar_item'
          }`}
        >
      ...
      >
        <div
          className={`${
            path === '/chart' ? 'sidebar-item-selector' : 'sidebar_item'
          }`}
        >
      ...
      >
        <div
          className={`${
            path === '/staff' ? 'sidebar-item-selector' : 'sidebar_item'
          }`}
        >
      ...
      >
        <div
          className={`${
            path === '/schedule' ? 'sidebar-item-selector' : 'sidebar_item'
          }`}
        >
      ...
      >
        <div
          className={`${
            path === '/report' ? 'sidebar-item-selector' : 'sidebar_item'
          }`}
        >
          <Icon icon="la:file-invoice-dollar" />
          <span>Báo Cáo</span>
      ...
      >
        <div
          className={`${
            path === '/account' ? 'sidebar-item-selector' : 'sidebar_item'
          }`}
        >
