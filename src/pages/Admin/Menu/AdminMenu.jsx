      ...
      <div>
        ...
        <Link to="/deposit">
          <div className={`${ path==='/deposit' ? 'sidebar-item-selector' : 'sidebar_item' }`}>
            <i className="bi bi-send-plus-fill menu-item-icon"></i>
            <span>Ký Gửi</span>
          </div>
        </Link>
        <Link to="/pay">
          <div className={`${ path==='/pay' ? 'sidebar-item-selector' : 'sidebar_item' }`}>
            <i className="bi bi-currency-exchange menu-item-icon"></i>
        ...
        <Link to="/customer">
          <div className={`${ path==='/customer' ? 'sidebar-item-selector' : 'sidebar_item' }`}>
            <i className="bi bi-people-fill menu-item-icon"></i>
