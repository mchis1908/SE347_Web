...
function EmployeeDetailInvoice(props) {
  ...
  return (
    <div className="EmployeeDetailInvoice" >
      <div className="EmployeeDetailInvoice_modal" >
        <div className="EmployeeDetailInvoice_modal-header">
          <h3>{props.title}</h3>
          <button className='button-exit' onClick={props.onClose}>X</button>
        </div>
        <div className="EmployeeDetailInvoice_Bottom">
          <div ref={componentRef}>
            <div className='EmployeeDetailInvoice_Detail'>
              <div className='EmployeeDetailInvoice_Detail_Content_Date'>
                <p className='EmployeeDetailInvoice_Detail_Content_LabelDay'>Ngày lập hóa đơn: </p>
                <p className='EmployeeDetailInvoice_Detail_Content_Calendar'>{hoadons.NGAYTAODON}</p>
              </div>
              <div className='EmployeeDetailInvoice_Detail_Content_Date'>
                <p className='EmployeeDetailInvoice_Detail_Content_LabelDay'>Ngày thanh toán: </p>
                <p className='EmployeeDetailInvoice_Detail_Content_Calendar'>{hoadons.NGAYTHANHTOAN}</p>
              </div>
              <div className='EmployeeDetailInvoice_Detail_Content_Date'>
                <p className='EmployeeDetailInvoice_Detail_Content_LabelDay'>Khách hàng: </p>
                <p className='EmployeeDetailInvoice_Detail_Content_Customer'>{hoadons.SDT}</p>
              </div>
              <div className='EmployeeDetailInvoice_Detail_Content_Date'>
                <p className='EmployeeDetailInvoice_Detail_Content_LabelDay'>Mã hóa đơn:</p>
                <p className='EmployeeDetailInvoice_Detail_Content_Customer'>{hoadons.MAHOADON}</p>
              </div>
            ...
            <div className='EmployeeDetailInvoice_ProductList' >
              {
          ...
          {/* -------------------------------------------------------------- */}
          <div className='EmployeeDetailInvoice_modal_Btn_Change'>
            <button className='EmployeeDetailInvoice_modal_Btn_Change_Cancel' onClick={props.onClose}>Hủy bỏ</button>
            <button className='EmployeeDetailInvoice_modal_Btn_Change_PrintInvoice' onClick={handlePrint}>In hóa đơn</button>
            {/* <button className='EmployeeDetailInvoice_modal_Btn_Change_PrintBarcode' onClick={handlePrint}>In barcode sản phẩm</button> */}
            <button className='EmployeeDetailInvoice_modal_Btn_Change_Confirm' onClick={handleConfirm} style={{display: props.db ? 'none' : 'block'}}>Thanh toán cho khách</button>
          </div>
        </div>
...
export default EmployeeDetailInvoice