...
function EmployeeDetailDeposit(props) {
  ...
  return (
    <div className="EmployeeDetailDeposit">
      <div className="EmployeeDetailDeposit_modal">
        <div className="EmployeeDetailDeposit_modal-header">
          <h3>{props.title}</h3>
          <button onClick={props.onClose}>X</button>
        </div>
        <div className="EmployeeDetailDeposit_modal-body">
          {props.children}
          <div className='EmployeeDetailDeposit_modal-body-inf_label'>
          ...
          <div className='EmployeeDetailDeposit_modal-body-inf_input'>
        ...
        <div className='EmployeeDetailDeposit_modal_Btn_Change'>
            <button className='EmployeeDetailDeposit_modal_Btn_Change_Cancel' onClick={props.onClose}>Hủy bỏ</button>
            <button className='EmployeeDetailDeposit_modal_Btn_Change_Delete' style={{ display: props.data ? 'block' : 'none' }} onClick={handleDelete}>Xóa sản phẩm</button>
            <button className='EmployeeDetailDeposit_modal_Btn_Change_Confirm' onClick={submitHandler}>Xác nhận</button>
        </div>
      </div>
    </div>
  )
...
export default EmployeeDetailDeposit