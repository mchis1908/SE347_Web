...
function EmployeeAddCustomer(props) {
  ...
  return (
    <div className="EmployeeAddCustomer">
      <div className="EmployeeAddCustomer_modal">
        <div className="EmployeeAddCustomer_modal-header">
          <h3>{props.title}</h3>
          <button onClick={props.onClose}>X</button>
        </div>
        <div className="EmployeeAddCustomer_modal-body">
          {props.children}
          <div className='EmployeeAddCustomer_modal-body-inf_label'>
          ...
          <div className='EmployeeAddCustomer_modal-body-inf_input'>
        ...
        <div className='EmployeeAddCustomer_modal_Btn_Change'>
            <button className='EmployeeAddCustomer_modal_Btn_Change_Cancel' onClick={props.onClose}>Hủy bỏ</button>
            <button className='EmployeeAddCustomer_modal_Btn_Change_Confirm' onClick={handelConfirm}>Xác nhận</button>
        </div>
      </div>
    </div>
  )
