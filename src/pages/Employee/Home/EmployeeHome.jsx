...
// function EmployeeHome({ isAuthenticated }) {
//   if (!isAuthenticated) {
//     return <Navigate to="/" />;
//   }
        ...
        <div className="EmployeeHome_Bottom">
          <div className="EmployeeHome_Chart">
            <div className="EmployeeHome_Chart_Label">
              <div className="Chart_Name">
                Biểu đồ sản phẩm ký gửi và bán ra
              </div>
          ...
          <div className="EmployeeHome_CustomerRecent">
                ...
                if (index < 10) {
                  return (
                    <div className="CustomerRecent_Info">
                      ...
                      <div className="CustomerRecent_Phone">
                        {khachhangs.SDT}
                      </div>
                    </div>
                  );
            ...
            <Link to="/employee/customer">
              <div className="CustomerRecent_ViewMore">
                Xem thêm <Icon icon="ic:round-read-more" color="#878787" />
              </div>
            </Link>
          </div>
        </div>
